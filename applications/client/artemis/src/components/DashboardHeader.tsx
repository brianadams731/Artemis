...
import { ProfileModalState } from "../interfaces/ProfileModalState";
import { ProfileModal } from "./ProfileModal";

const DashboardHeader = (): JSX.Element => {
    //const [search, setSearch] = useState<string>("");
    const navigate = useNavigate();
    const [profileModalState, setProfileModalState] = useState<ProfileModalState>({ state: "closed" });
    ...
    return (
        <header className={styles.wrapper}>
            ...
            <div className={styles.navatar}>
                ...
                {profileModalState.state === "open" && <ProfileModal state={profileModalState.state} closeModal={() => {
                    setProfileModalState({ state: "closed" });
                }} />}
                <div className={styles.avatar} onClick={async ()=>{
                     <ProfileModal state="open" closeModal={() => {setProfileModalState({state: "closed"})}} />
                     console.log("click")
                }}> 
