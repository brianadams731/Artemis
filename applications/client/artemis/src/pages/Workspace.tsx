...
const Workspace = (): JSX.Element => {
    ...
    return (
        <div className={styles.outerWrap}>
            <img className={styles.background} src='/assets/backgroundHex.svg' />
            <AnimatePresence>
                ...
                {boardModalState.state === "open" && <EditBoardModal id={boardModalState.board.id} name={boardModalState.board.name} closeModal={() => setBoardModalState({ state: "closed" })} mutateWorkspace={mutateWorkspace}/>}
            </AnimatePresence>
                        ...
                        <div key={board.id} className={styles.boardWrapper}>
                            <div className={styles.boardHead}>
                                ...
                                <button className={styles.boardSetting} style={board.name.toLowerCase() === "unassigned".toLowerCase() ? { pointerEvents: "none" } : {}} onClick={()=>{
                                    setBoardModalState({state:"open", board: board});
                                }}>
